    ...
    return (
        <div className='all'>
            ...
            <div className='aall'>
                ...
                <div style={{ flex: 1 }}>
                    <h3 className='hthree'>JavaScript</h3>
                    <textarea
                        value={jsCode}
            ...
            <div style={{ display: 'flex', justifyContent: 'center', marginBottom: '20px' }}>
                <button onClick={handleCopyCode} className='btnOfIc'>Copy</button>
                <button onClick={handleDownloadCode} className='btnOfIc'>Download</button>
            </div>
